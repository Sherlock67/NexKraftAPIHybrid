...
namespace API.Controllers
{
    ...
    [ApiController]
    public class CustomerOldController : ControllerBase
    {
        private readonly ICustomerServicesOld serivce; private readonly IMemoryCache memoryCache;
        public CustomerOldController(ICustomerServicesOld _serivce, IMemoryCache memoryCache)
        {
            serivce = _serivce;
