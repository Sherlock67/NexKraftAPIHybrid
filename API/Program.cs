...
StaticInfos.OracleConnectionString = _configuration.GetValue<string>("OracleConnectionString");
...
builder.Services.AddTransient(_ => new OracleDbConnection(StaticInfos.OracleConnectionString));
